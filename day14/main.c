...
//Recursive method to get the value of the provided string value
//@param value -- bit string to eval 
...
void part2() {
	...
	while(curr) {
		...
		/* handle memory input */
			...
			char * newValue = applyMaskV2(currentMask, memAddress);				//apply mask to value provided
